...
import 'strings_bi.g.dart' deferred as l_bi;
import 'strings_ca.g.dart' deferred as l_ca;
import 'strings_cs.g.dart' deferred as l_cs;
import 'strings_cv.g.dart' deferred as l_cv;
...
import 'strings_lb.g.dart' deferred as l_lb;
import 'strings_lt.g.dart' deferred as l_lt;
import 'strings_lv.g.dart' deferred as l_lv;
import 'strings_mfa.g.dart' deferred as l_mfa;
...
import 'strings_nb_NO.g.dart' deferred as l_nb_NO;
import 'strings_nl.g.dart' deferred as l_nl;
import 'strings_nn.g.dart' deferred as l_nn;
...
import 'strings_sr_Latn.g.dart' deferred as l_sr_Latn;
...
enum AppLocale with BaseAppLocale<AppLocale, Translations> {
	...
	mr(languageCode: 'mr'),
	ms(languageCode: 'ms'),
	nbNo(languageCode: 'nb', countryCode: 'NO'),
	nl(languageCode: 'nl'),
	nn(languageCode: 'nn'),
	pl(languageCode: 'pl'),
	pt(languageCode: 'pt'),
	...
	srLatn(languageCode: 'sr', scriptCode: 'Latn'),
	sv(languageCode: 'sv'),
	ta(languageCode: 'ta'),
	te(languageCode: 'te'),
	th(languageCode: 'th'),
	...
	Future<Translations> build({
		...
		switch (this) {
			...
			case AppLocale.bi:
				await l_bi.loadLibrary();
				return l_bi.TranslationsBi(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
			...
			case AppLocale.cv:
				await l_cv.loadLibrary();
				return l_cv.TranslationsCv(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
			...
			case AppLocale.lb:
				await l_lb.loadLibrary();
				return l_lb.TranslationsLb(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
			...
			case AppLocale.mfa:
				await l_mfa.loadLibrary();
				return l_mfa.TranslationsMfa(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
			...
			case AppLocale.nbNo:
				await l_nb_NO.loadLibrary();
				return l_nb_NO.TranslationsNbNo(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
			...
			case AppLocale.nn:
				await l_nn.loadLibrary();
				return l_nn.TranslationsNn(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
			...
			case AppLocale.srLatn:
				await l_sr_Latn.loadLibrary();
				return l_sr_Latn.TranslationsSrLatn(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
